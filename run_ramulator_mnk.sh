...
python3 -m scalesim.scale -c ./configs/google.cfg -t ${topology} -i gemm > ${1}_${2}_orig_out
python3 scripts/dram_sim.py -run_name GoogleTPU_v1_os
python3 scripts/dram_latency.py
python3 -m scalesim.scale -c ./configs/google_ramulator.cfg -t ${topology} -i gemm > ${1}_${2}_stall_out
