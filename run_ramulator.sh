...
python3 -m scalesim.scale -c ./configs/google.cfg -t ${topology} > ${1}_${2}_orig_out
python scripts/dram_sim.py -run_name GoogleTPU_v1_os
python scripts/dram_latency.py
python3 -m scalesim.scale -c ./configs/google_ramulator.cfg -t ${topology} > ${1}_${2}_stall_out
